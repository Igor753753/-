...
class InstagramcomSpider(scrapy.Spider):
    ...
    posts_hash_subscribers = 'c9676de99cc02f6415203be841dd27e'
    posts_hash_subscriptions = 'c64b0a943b4c54837d0d870b0e64e073'
...
def parse(self, response: HtmlResponse):
    ...
    yield scrapy.FormRequest(
        ...
        formdata={'username': self.inst_login, 'enc_password': self.inst_passw},
